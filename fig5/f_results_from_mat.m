function [figs, results] = f_results_from_mat(gene, label, dataDir_3day, dataDir_endpoint, baseName_3day, baseName_endpoint, numBins)
% 3 day analysis: KL
...
pseudocount = 0.00001;
DATA_neg.Ratio = log(DATA_neg.Ratio + pseudocount);
DATA_pos.Ratio = log(DATA_pos.Ratio + pseudocount);
